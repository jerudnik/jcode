...
include!("tests/state_model_poke_04.rs");
...
fn deferred_stale_server_history_captures_session_id_for_reload_handoff() {
    ...
    // (e.g. right after a client reload), the History payload is deferred because
