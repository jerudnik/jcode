...
pub(in crate::server) use self::swarm::{
    ...
    send_swarm_plan_to_session, set_member_subagent_type, set_member_task_label,
...
impl Server {
    ...
    async fn recover_headless_sessions_on_startup(&self) {
        ...
        for session_id in sessions_to_restore {
            ...
            let registry = crate::tool::Registry::new(provider.clone())
                .await
                .with_swarm_state(self.swarm_state.clone());
