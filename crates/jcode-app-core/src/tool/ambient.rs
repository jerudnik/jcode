...
pub(crate) use ambient_gate::check_ambient_action_tier;
use ambient_gate::ensure_ambient_session;
#[cfg(test)]
use ambient_gate::is_ambient_session_registered;
pub use ambient_gate::{AmbientSessionGuard, register_ambient_session, unregister_ambient_session};
