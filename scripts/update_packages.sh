...
LINUX_URL="https://github.com/jerudnik/jcode/releases/download/${VERSION}/jcode-linux-x86_64.tar.gz"
LINUX_ARM_URL="https://github.com/jerudnik/jcode/releases/download/${VERSION}/jcode-linux-aarch64.tar.gz"
MACOS_ARM_URL="https://github.com/jerudnik/jcode/releases/download/${VERSION}/jcode-macos-aarch64.tar.gz"
MACOS_INTEL_URL="https://github.com/jerudnik/jcode/releases/download/${VERSION}/jcode-macos-x86_64.tar.gz"
...
arch=('x86_64')
url="https://github.com/jerudnik/jcode"
license=('MIT')
provides=('jcode')
conflicts=('jcode')
source=("$LINUX_URL")
