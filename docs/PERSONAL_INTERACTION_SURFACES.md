...
Start here for visual and interaction decisions. Use [`INTERACTION_SURFACES.md`](./INTERACTION_SURFACES.md) as the project map, [`INTERACTION_SURFACE_REQUIREMENTS.md`](./INTERACTION_SURFACE_REQUIREMENTS.md) for implementation work, and `SURFACE_WORKSPACE_SUBSTRATE_PLAN.md` (private planning note, not in this repository) for cards/docs/annotations storage.
