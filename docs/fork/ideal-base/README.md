...
- [`POST_DISTRIBUTION_ORCHESTRATOR_PLAN.md`](POST_DISTRIBUTION_ORCHESTRATOR_PLAN.md): the active post-distribution execution plan for governance repair (R07 closed 2026-07-29), remaining W4/W5 execution, and final signoff.
