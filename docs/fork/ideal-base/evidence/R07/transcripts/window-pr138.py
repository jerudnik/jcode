#!/usr/bin/env python3
"""R07 design.md section 4 maintenance window -- PR #138 (atomic final-child/root checkpoint).
...
this program has already paid for:
  ...
  2. BASE-PINNED ENCODER. Restoration semantics must never be trusted to
     the candidate worktree. The canonical hash and restoration body use the
...
REPO_ID = 1238606714
RULESET_ID = 18509013
HEAD_REF = "automation/s03-atomic-checkpoint"
...
REVIEWED_HEAD = "35fca50c71eaa1b684a3d70c91ded1abbd66995f"
