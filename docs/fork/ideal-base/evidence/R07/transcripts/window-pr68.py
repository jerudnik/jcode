#!/usr/bin/env python3
"""R07 design.md section 4 maintenance window — PR #59.
...
REVIEWED_HEAD = "ccaa8d0c7e85ca286a6a9d0ddac5840f4e3e09f9"
...
EXPECTED_GOVERNANCE_PATHS = [".github/workflows/fork-ci.yml", "scripts/check_critical_path_budget.py"]
