...
run_expect classifier 0 /Library/Developer/CommandLineTools/usr/bin/python3 -m unittest discover -s tests -p test_rust_production_filter.py
run_expect classifier_compile 0 /Library/Developer/CommandLineTools/usr/bin/python3 -m py_compile \
...
run_expect dependency 0 /Library/Developer/CommandLineTools/usr/bin/python3 scripts/check_dependency_boundaries.py
run_expect wildcard 0 /Library/Developer/CommandLineTools/usr/bin/python3 scripts/check_wildcard_reexport_budget.py
...
run_expect swallowed 1 /Library/Developer/CommandLineTools/usr/bin/python3 scripts/check_swallowed_error_budget.py
run_expect swallowed_exact 0 grep -F '2987 -> 3074' "$out/raw/swallowed.txt"
run_expect code_size 1 /Library/Developer/CommandLineTools/usr/bin/python3 scripts/check_code_size_budget.py
run_expect test_size 1 /Library/Developer/CommandLineTools/usr/bin/python3 scripts/check_test_size_budget.py

run_expect no_update_invocation 0 /Library/Developer/CommandLineTools/usr/bin/python3 -c \
