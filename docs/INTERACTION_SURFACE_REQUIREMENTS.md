...
- Surface workspace substrate: `SURFACE_WORKSPACE_SUBSTRATE_PLAN.md` (private planning note, not in this repository)
...
Use `INTERACTION_SURFACE_IMPLEMENTATION_PROMPT.md` (private planning note, not in this repository) for the next full implementation session. The smaller prompts below are slice-specific shortcuts.
