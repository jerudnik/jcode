...
Canonical future layout: `specs/<name>/SPEC.md`.

Required frontmatter:
- `name`: lowercase kebab-case identifier matching the parent directory.
- `description`: one-line summary of the specification.
...
Validation: `python3 scripts/validate_agent_content.py` once spec files exist.
