...
pub(crate) fn initial_title(args: &Args) -> String {
    match &args.command {
        ...
        Some(Command::McpServe { .. }) => "jcode mcp-serve".to_string(),
        ...
        Some(Command::Assistant(_)) => "jcode assistant".to_string(),
        ...
        Some(Command::MobileServer { .. }) => "jcode mobile-server".to_string(),
